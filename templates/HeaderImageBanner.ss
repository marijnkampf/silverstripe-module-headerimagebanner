<% if showHibImages %>
	...
	<div class="slider-wrapper theme-default"><ul id="slider" class="nivoSlider"><% control showHibImages(5) %><li><img src="$hibCroppedImage.URL" alt="Photo credit: $hibCroppedImage.Title" title="Photo credit: $hibCroppedImage.Title" /></li><% end_control %>
